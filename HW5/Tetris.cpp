...
Tetris::Tetris(const int &height1, const int &width1){
    int i,j;
...
int Tetris:: getlc()const{
    return lc;
}

int Tetris:: getrc()const{
    return rc;
}

void Tetris:: setlc(int value){
    lc = value;
}

void Tetris:: setrc(int value){
    rc = value;
}

// to determine wheter it is 'I' tetromino and its position is vertical or not
bool Tetris:: isI(const Tetromino &piece, const char &direction)const{
    if(direction == 'R'){
...
bool Tetris:: check_index(const char &direction, const int &count)const{
    if(direction == 'R'){
...
void Tetris:: add(const Tetromino &piece, const int &y, const int &x)const{
    int i,j,tempx;
...
void Tetris:: animate(Tetromino &piece){
...
void Tetris:: erase(const Tetromino &piece)const{
    int i,x,y;
...
void Tetris:: erase(const Tetromino &piece, const int &start_column)const{
    int i,j;
...
Tetris& Tetris:: operator+=(const Tetromino& oth){
    int i,j,x,y;
