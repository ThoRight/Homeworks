...
void TetrisArray1D:: add(const Tetromino &piece, const int &y, const int &x){
    int i,j,tempx,indx;
...
void TetrisArray1D:: animate(Tetromino &piece, string d1, int c1, string d2, int c2){
...
void TetrisArray1D:: erase(const Tetromino &piece){
    int i,x,y,indx;
...
void TetrisArray1D::writeToFile(const char* file){
    int indx,i,j;
...
void TetrisArray1D::readfromFile(const char* file){
    int indx,r=2,w=0;
    string game;
    fstream fp; 
    fp.open(file, ios::in);
...
void TetrisArray1D:: erase(const Tetromino &piece, const int &start_column){
    int i,j,indx;
...
void TetrisArray1D:: operator+=(const Tetromino& oth){
    int i,j,x,y,indx;
