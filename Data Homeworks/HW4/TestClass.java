    ...
    public static void main(String[] args){
        ...
        for(int i=0;i<usernames.length;++i){
            ...
            if(!u.checkIfValidUsername(usernames[i],usernames[i].length()-1))
                ...
                valid = false;
            else if(!pw1.isPalindromePossible(password1s[i],0,password1s[i].length()-1,false))
                valid = false;
                ...
                // Print is not in recursive function because two functions is returned in recursive case. We don't want to be more than one prints.
                valid = false;
            }
            if(valid)
