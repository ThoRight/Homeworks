...
public class Password1{
     ...
     */
    public boolean isPalindromePossible(String password1, int start, int end, int change, boolean simplified){
        ...
        if(!simplified){
            ...
            return isPalindromePossible(simplifiedPw1,0,simplifiedPw1.length()-1,1,true);
        }
        ...
        else if(start+change>=password1.length()){
            System.out.println("The password1 is invalid. It should be possible to obtain a palindrome from the password1.");
            return false;
        }
        else if(password1.charAt(start) == password1.charAt(end)){
            return isPalindromePossible(password1,start+1,end-1,1,true);
        }
        else{
            char a = password1.charAt(start);
            char b = password1.charAt(start+change);
            password1 = password1.replace(a,b);
            password1 = password1.replace(b,a);
            return isPalindromePossible(password1,start,end,change+1,true);
        }
    }
