...
public class Account{
     ...
     */
    public void viewInteractions(ArrayList<Account> accs, Account target){
        if(!isLogin()){
     ...
     */
    public void viewInbox(ArrayList<Account> accs){
        if(!isLogin()){
     ...
     */
    public String findaccname(ArrayList<Account> accs, int id){
     ...
     * @param accs[] to print information with accounts' usernames.
     */
    public void viewOutbox(ArrayList<Account> accs){
        if(!isLogin()){
